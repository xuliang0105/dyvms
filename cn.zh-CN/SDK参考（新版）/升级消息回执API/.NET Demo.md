# .NET Demo {#concept_cgf_xjl_3gb .concept}

依赖.NET语言的阿里云SDK核心库及dybaseapi，其中dybaseapi包用于拉取MNS消息。

-   [阿里云SDK核心库](https://github.com/aliyun/aliyun-openapi-net-sdk/tree/master/aliyun-net-sdk-core)
-   [dybaseapi](https://github.com/aliyun/aliyun-openapi-net-sdk/tree/master/aliyun-net-sdk-dybaseapi)
